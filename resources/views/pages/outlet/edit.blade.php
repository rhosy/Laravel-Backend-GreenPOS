                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text"
                                            class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $outlet->name }}" required>
                                        @error('name')
                                        ...
                                        @enderror" name="province_id">
                                            @foreach ($provinces as $province)
                                                <option value="{{ $province->id }}" 
                                                    {{$outlet->province_id == $province->id ? 'selected' : ''}}>
                                                    {{ $province->name ?? "" }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        @foreach ($cities as $city) 
                                            <option value="{{ $city->id }}" 
                                                {{$outlet->city_id == $city->id ? 'selected' : ''}}>
                                                {{ $city->name ?? ""}}
                                            </option>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district->id }}" 
                                                {{$outlet->district_id == $district->id ? 'selected' : ''}}>
                                                {{ $district->name ?? ""}}
                                            </option>
